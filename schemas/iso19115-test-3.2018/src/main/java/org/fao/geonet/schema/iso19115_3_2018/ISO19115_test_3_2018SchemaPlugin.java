...
import static org.fao.geonet.schema.iso19115_3_2018.ISO19115_test_3_2018Namespaces.XLINK;


public class ISO19115_test_3_2018SchemaPlugin
    ...
    public static final String IDENTIFIER = "iso19115-test-3";
    ...
    static {
        allNamespaces = ImmutableSet.<Namespace>builder()
            .add(ISO19115_test_3_2018Namespaces.GCO)
            .add(ISO19115_test_3_2018Namespaces.MDB)
            .add(ISO19115_test_3_2018Namespaces.GEX)
            .add(ISO19115_test_3_2018Namespaces.MRC)
            .add(ISO19115_test_3_2018Namespaces.MRL)
            .add(ISO19115_test_3_2018Namespaces.LAN)
            .add(ISO19115_test_3_2018Namespaces.MRI)
            .add(ISO19115_test_3_2018Namespaces.CIT)
            .add(ISO19115_test_3_2018Namespaces.SRV)
            .add(XLINK)
            .build();
    ...
    public ISO19115_test_3_2018SchemaPlugin() {
    ...
    private AssociatedResource metadataRefAsAssociatedResource(Element sibling) {
        Element ref = sibling.getChild("metadataReference", ISO19115_test_3_2018Namespaces.MRI);
        String sibUuid = ref.getAttributeValue("uuidref");

        String associationType = sibling.getChild("associationType", ISO19115_test_3_2018Namespaces.MRI)
            .getChild("DS_AssociationTypeCode", ISO19115_test_3_2018Namespaces.MRI)
            .getAttributeValue("codeListValue");

        String initType = "";
        final Element initiativeTypeEl = sibling.getChild("initiativeType", ISO19115_test_3_2018Namespaces.MRI);
        if (initiativeTypeEl != null) {
            initType = initiativeTypeEl.getChild("DS_InitiativeTypeCode", ISO19115_test_3_2018Namespaces.MRI)
                .getAttributeValue("codeListValue");
        }
    ...
    public void addTranslationToElement(Element element, String languageIdentifier, String value) {
        ...
        Element langElem = new Element("LocalisedCharacterString", ISO19115_test_3_2018Namespaces.LAN);
        langElem.setAttribute("locale", "#" + languageIdentifier);
        langElem.setText(value);
        Element textGroupElement = new Element("textGroup", ISO19115_test_3_2018Namespaces.LAN);
        textGroupElement.addContent(langElem);

        // Get the PT_FreeText node where to insert the translation into
        Element freeTextElement = element.getChild("PT_FreeText", ISO19115_test_3_2018Namespaces.LAN);
        if (freeTextElement == null) {
            freeTextElement = new Element("PT_FreeText", ISO19115_test_3_2018Namespaces.LAN);
    ...
    public Element removeTranslationFromElement(Element element, List<String> langs) throws JDOMException {
        ...
        List<Element> nodesWithStrings = (List<Element>) Xml.selectNodes(element, "*//lan:PT_FreeText", Arrays.asList(ISO19115_test_3_2018Namespaces.LAN));

        for (Element e : nodesWithStrings) {
            // Retrieve or create the main language element
            Element mainCharacterString = ((Element) e.getParent()).getChild("CharacterString", ISO19115_test_3_2018Namespaces.GCO);
            if (mainCharacterString == null) {
                // create it if it does not exist
                mainCharacterString = new Element("CharacterString", ISO19115_test_3_2018Namespaces.GCO);
            ...
            List<Element> mainLangElement = (List<Element>) Xml.selectNodes(
                ...
                Arrays.asList(ISO19115_test_3_2018Namespaces.LAN));
            ...
            if (mainLangElement.size() == 1) {
                ...
                } else if (mainCharacterString.getAttribute("nilReason", ISO19115_test_3_2018Namespaces.GCO) == null) {
                    ((Element) mainCharacterString.getParent()).setAttribute("nilReason", "missing", ISO19115_test_3_2018Namespaces.GCO);
                }
    ...
    public Element createBasicTypeCharacterString() {
        return new Element("CharacterString", ISO19115_test_3_2018Namespaces.GCO);
    ...
    public Element addOperatesOn(Element serviceRecord,
        ...
        Element root = serviceRecord
            .getChild("identificationInfo", ISO19115_test_3_2018Namespaces.MDB)
            .getChild("SV_ServiceIdentification", ISO19115_test_3_2018Namespaces.SRV);

        if (root != null) {

            // Coupling type MUST be present as it is the insertion point
            // for coupledResource
            Element couplingType = root.getChild("couplingType", ISO19115_test_3_2018Namespaces.SRV);
            ...
            layers.keySet().forEach(uuid -> {
                ...
                Element coupledResource = new Element("coupledResource", ISO19115_test_3_2018Namespaces.SRV);
                coupledResource.setAttribute("nilReason", "synchronizedFromOGC", ISO19115_test_3_2018Namespaces.GCO);
                Element scr = new Element("SV_CoupledResource", ISO19115_test_3_2018Namespaces.SRV);


                // Create operation according to service type
                Element operation = new Element("operation", ISO19115_test_3_2018Namespaces.SRV);
                Element operationMetadata = new Element("SV_OperationMetadata", ISO19115_test_3_2018Namespaces.SRV);
                Element operationName = new Element("operationName", ISO19115_test_3_2018Namespaces.SRV);
                Element operationValue = new Element("CharacterString", ISO19115_test_3_2018Namespaces.GCO);
                ...
                Element id = new Element("resourceReference", ISO19115_test_3_2018Namespaces.SRV);
                ...
                Element scopedName = new Element("scopedName", ISO19115_test_3_2018Namespaces.SRV);
                Element scopedNameValue = new Element("ScopedName", ISO19115_test_3_2018Namespaces.GCO);
...
//                scr.addContent(operation);
                ...
                Element op = new Element("operatesOn", ISO19115_test_3_2018Namespaces.SRV);
                op.setAttribute("nilReason", "synchronizedFromOGC", ISO19115_test_3_2018Namespaces.GCO);
    ...
    public List<Extent> getExtents(Element metadataRecord) {
        ...
        ElementFilter bboxFinder = new ElementFilter("EX_GeographicBoundingBox", ISO19115_test_3_2018Namespaces.GEX);
        @SuppressWarnings("unchecked")
        ...
        while (bboxes.hasNext()) {
            ...
            try {
                extents.add(new Extent(
                    Double.valueOf(box.getChild("westBoundLongitude", ISO19115_test_3_2018Namespaces.GEX).getChild("Decimal", ISO19115_test_3_2018Namespaces.GCO).getText()),
                    Double.valueOf(box.getChild("eastBoundLongitude", ISO19115_test_3_2018Namespaces.GEX).getChild("Decimal", ISO19115_test_3_2018Namespaces.GCO).getText()),
                    Double.valueOf(box.getChild("southBoundLatitude", ISO19115_test_3_2018Namespaces.GEX).getChild("Decimal", ISO19115_test_3_2018Namespaces.GCO).getText()),
                    Double.valueOf(box.getChild("northBoundLatitude", ISO19115_test_3_2018Namespaces.GEX).getChild("Decimal", ISO19115_test_3_2018Namespaces.GCO).getText())
                ));
        ...
        if (elementToProcess && parsedAttributeName.equals("xlink:href")) {
            ...
            if (isMultilingualElement) {
                ...
                Element targetElement = el.getParentElement().getParentElement().getParentElement()
                    .getChild("CharacterString", ISO19115_test_3_2018Namespaces.GCO);
            ...
            if (isEmptyLink) {
                el.setNamespace(ISO19115_test_3_2018Namespaces.GCO).setName("CharacterString");
                el.removeAttribute("href", XLINK);
                return el;
            } else {
                el.setNamespace(ISO19115_test_3_2018Namespaces.GCX).setName("Anchor");
    ...
    public <L, M> RawLinkPatternStreamer<L, M> createLinkStreamer(ILinkBuilder<L, M> linkbuilder, String excludePattern) {
        ...
        patternStreamer.setNamespaces(ISO19115_test_3_2018SchemaPlugin.allNamespaces.asList());
        // TODO: Add xlink:href ?
