...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:gn-fn-iso19115-test-3.2018="http://geonetwork-opensource.org/xsl/functions/profiles/iso19115-test-3.2018"
  xmlns:gn-fn-metadata="http://geonetwork-opensource.org/xsl/functions/metadata"
  exclude-result-prefixes="#all">


  <xsl:function name="gn-fn-iso19115-test-3.2018:write-date-or-dateTime" as="node()">
  ...
  prefixed by #.
        -->
  <xsl:function name="gn-fn-iso19115-test-3.2018:getLangId" as="xs:string">
    <xsl:param name="md"/>
    <xsl:param name="lang"/>
  ...
  <xsl:function name="gn-fn-iso19115-test-3.2018:getCodeListType" as="xs:string">
  ...
  <xsl:function name="gn-fn-iso19115-test-3.2018:isNotMultilingualField" as="xs:boolean">
  ...
  <!--
    ...
    * split by value separator (usually #) to get each language code and value pair.
    ...
    to get the value.
   -->
  <xsl:function name="gn-fn-iso19115-test-3.2018:fillTextElement" as="node()*">
    <xsl:param name="string" as="xs:string"/>
    <xsl:param name="mainLanguage" as="xs:string?"/>
    <xsl:param name="useOnlyPTFreeText" as="xs:boolean"/>

    <xsl:copy-of select="gn-fn-iso19115-test-3.2018:fillTextElement($string, '\|', '#', $mainLanguage, $useOnlyPTFreeText)"/>
  </xsl:function>
