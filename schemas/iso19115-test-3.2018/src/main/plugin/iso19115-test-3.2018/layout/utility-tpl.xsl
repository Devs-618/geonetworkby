...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-iso19115-test-3.2018-is-service">
    <xsl:value-of
            select="count($metadata/mdb:identificationInfo/srv:SV_ServiceIdentification) > 0"/>
  </xsl:template>

  <xsl:template name="get-iso19115-test-3.2018-title">
...
"/>
  ...
  <xsl:template name="get-iso19115-test-3.2018-extents-as-json">[
  ...
  <xsl:template name="get-iso19115-test-3.2018-online-source-config">
