...
package org.fao.geonet.schema.dublintest;
...
public class DublinTestSchemaPlugin
    ...
    static {
        allNamespaces = ImmutableSet.<Namespace>builder()
            .add(DublinTestNamespaces.DC)
            .add(DublinTestNamespaces.DCT)
            .build();
    ...
    public Set<AssociatedResource> getAssociatedParents(Element metadata) {
        ElementFilter elementFilter = new ElementFilter("isPartOf", DublinTestNamespaces.DCT);
