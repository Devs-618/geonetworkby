...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/elements/1.1/"
  ...
  <xsl:template name="get-dublin-test-title">
    <xsl:value-of select="$metadata//dc:title"/>
  </xsl:template>

  <!-- Visit all tree -->
  <xsl:template mode="mode-dublin-test" match="dc:*|dct:*">
    <xsl:apply-templates mode="mode-dublin-test" select="*|@*"/>
  </xsl:template>


  <!-- Forget those DC elements -->
  <xsl:template mode="mode-dublin-test"
                match="dc:*[
  ...
  <xsl:template mode="mode-dublin-test" priority="200" match="simpledt">
  ...
  <!-- Forget all elements ... -->
  <xsl:template mode="mode-dublin-test" match="gn:*|@*"/>
  ...
  <xsl:template mode="mode-dublin-test" match="gn:child[contains(@name, 'CHOICE_ELEMENT')]"
                priority="2000">
  ...
  <xsl:template mode="mode-dublin-test" priority="101"
  ...
  <xsl:template mode="mode-dublin-test" priority="100" match="dc:*|dct:*">
  ...
  <!-- Readonly elements -->
  <xsl:template mode="mode-dublin-test" priority="200" match="dc:identifier|dct:modified">
